...
func (in *EC2NodeClassStatus) DeepCopyInto(out *EC2NodeClassStatus) {
	*out = *in
	...
	if in.InstanceProfiles != nil {
		...
		*out = new(InstanceProfilesStatus)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InstanceProfilesStatus) DeepCopyInto(out *InstanceProfilesStatus) {
	*out = *in
	if in.Previous != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InstanceProfilesStatus.
func (in *InstanceProfilesStatus) DeepCopy() *InstanceProfilesStatus {
	if in == nil {
		return nil
	}
	out := new(InstanceProfilesStatus)
